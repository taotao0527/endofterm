...
<body>
	...
	<main class="card">
            ...
            <div class="container"><!--商品圖片&說明-->
                <div class="row">
                    <div class="row-left">
                        <img class="goods_s" src="../assets/img/product/painting_farm.jpg" >
                    </div>
                    <div class="row-right">
					<h3>拾穗者</h3>
                        <p>
...
//Step 3: 選擇資料庫   
		   ...
		   sql="SELECT*FROM `product`WHERE `PROID`='p08'";
...
//Step 3: 選擇資料庫   
           ...
           con.createStatement().execute(sql);
//Step 4: 
           sql="SELECT * FROM `guestbookp01`WHERE `product`='p08'"; //算出共幾筆留言
...
//Step 5: 顯示結果 
           ...
           sql="SELECT * FROM `guestbookp01` WHERE `product`='p08' ORDER BY `Putdate` DESC LIMIT ";
           sql+=start_record+",5";
