...
//Step 3: 選擇資料庫   
		   ...
		   sql="SELECT*FROM `product`WHERE `PROID`='p04'";//修改
...
//Step 3: 選擇資料庫   
           ...
           con.createStatement().execute(sql);
//Step 4: 
           sql="SELECT * FROM `guestbookp01`WHERE `product`='p04'"; //修改
...
//Step 5: 顯示結果 
           ...
           sql="SELECT * FROM `guestbookp01` WHERE `product`='p04' ORDER BY `Putdate` DESC LIMIT ";//修改
           sql+=start_record+",5";
