...
//Step 3: 選擇資料庫   
		   ...
		   sql="SELECT*FROM `product`WHERE `PROID`='p09'";
...
//Step 3: 選擇資料庫   
           ...
           con.createStatement().execute(sql);
//Step 4: 
           sql="SELECT * FROM `guestbookp01`WHERE `product`='p09'"; //算出共幾筆留言
...
//Step 5: 顯示結果 
           ...
           sql="SELECT * FROM `guestbookp01` WHERE `product`='p09' ORDER BY `Putdate` DESC LIMIT ";
           sql+=start_record+",5";
